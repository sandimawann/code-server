# Guide: Launching `sxlzptprjkt-code-server` on railway.app
...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template/kB3Wy6?referralCode=sxlmnwb)
